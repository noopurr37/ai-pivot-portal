...
import type { Message } from "@/hooks/useChatSidebar";

interface ChatSidebarMessagesProps {
  messages: Message[];
  isLoading: boolean;
  messagesEndRef: React.RefObject<HTMLDivElement>;
}

export function ChatSidebarMessages({ messages, isLoading, messagesEndRef }: ChatSidebarMessagesProps) {
  return (
