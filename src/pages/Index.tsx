        ...
        {uploadedFile && <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="bg-white/90 dark:bg-gray-800/90 rounded-lg p-6 shadow-lg">
              <div className="prose prose-sm dark:prose-invert max-w-none">
                <p className="leading-relaxed text-3xl text-neutral-950 text-left font-thin">Noopur is a certified conversational AI Architect, an artificial Intelligence enthusiast, speaker, and Georgia Tech Graduate majoring in Machine Learning. and a full-time Systems Engineer.</p>
                <p className="text-gray-800 dark:text-gray-200 leading-relaxed">
            </p>
                <p className="leading-relaxed py-[2px] text-gray-950">She serves on the board of Austin Women in Technology as Technical Director and startup founder</p>
                <p className="leading-relaxed text-neutral-950">
            </p>
              </div>
            </div>
          </div>}
